...
**Observations**: - Write your observations here! - The values for the
mean velocity across all distinctness values differ from the values
Michelson reported. With the exception of the distinctness value of 1,
all of the mean velocity values are less than those obtained by
Michelson. - Why might your table differ from Michelson’s? - The values
present in the table may differ from Michelson’s as a result of the use
of rounding in calculations throughout the process.
...
of the error is less than the true error as he believed that the true
value of the speed-of-light would be at most 51 m/s away from his best
estimate, while in reality the true value was 151.542 m/s away. - Make a
quantitative comparison between Michelson’s uncertainty and his error. -
Michelson’s uncertainty was that the true value of the speed-of-light
would lie either 51 m/s less or greater than his estimate. However, when
determining the actual error by subtracting the speed-of-light by the
true value, it is evident that Michelson underestimated his uncertainty
as the actual error was 151.542 m/s, meaning that there is a 101.542 m/s
discrepancy between his uncertainty and the actual error exhibited.
...
**Observations**: Similarities - The data appears to be centered around
the same range of values. Both the real and simulated have a wide range
of observed values for each day, and these ranges tend to exceed the
margins of error. Differences - The mean velocities of the real data
tend to go outwith the margin of error earlier in the measurement dates,
whereas the simulated tends to go out with the bounds later on in the
dates of measurement. Additionally, the simulated data tends to vary
more than the real data; the real tends to appear in clusters at each
day, as opposed to the widespread of measurements seen in the simulated
data.
...
- Second graph: The red points represent the mean velocity values at
  ...
  said, the means of distinctness levels of 1 and 2 could be skewed by
