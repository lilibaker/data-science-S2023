...
df_q4 <- df_q3 %>%
 summarize(
   mean = mean(income_estimate),
 ) %>% 
 mutate(
   income_SE = df_q3$income_moe / 1.645,
   income_CV = income_SE / df_q3$income_estimate,
   income_lo = mean - 2.576 * income_CV,
   income_hi = mean + 2.576 * income_CV,
 )
df_q4
```
