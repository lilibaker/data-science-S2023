...
- Was your sample size $n$ large enough? Why do you say that?
  - Yes, the sample size of 10,000 resulted in a confidence interval that included the value of $\pi$ at the 95% confidence level, and the mean value of `stat` was 3.13, which is fairly close to the actual value of $\pi$. While a larger sample size probably would have resulted in a more accurate value of `pi_mean`, the values obtained with the chosen sample size are very close to the actual value, suggesting that the sample size was sufficient.
