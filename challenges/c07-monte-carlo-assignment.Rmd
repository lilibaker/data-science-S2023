...
- Was your sample size $n$ large enough? Why do you say that?
  - Yes, the mean value of 3.14 is very close to the actual value of pi. Additionally, the confidence interval is pretty small and provides a close estimate to pi that the decrease in the width caused by an increase in samples would not have made a significant difference.
