...
- Are there any differences?
  - Yes, 2224 is the calculated total number of people on board
- If yes, what might account for those differences?
  - People cancelling the trip at the last minute
  - People travelling under an alias that were double-counted
...
- As the class decreases, the total number of women that survived tends
  to decrease, whilst the total number of men that survived tends to
  increase, with the exception of the second class. Additionally, women
  the total number of women that survived tends to be greater than that
  of men, with the exception of the crew.
...
- As the class decreases, the proportion of those who survived for both
  genders tends to decrease. However, the proportion of women that
  survived from the crew is much more than those from third class, which
  is the opposite of what is exhibited for men.
- Is there anything *fishy* going on in your plot?
  - It appears as though there is a 100% survival rate for both men and
    women in the first and second classes, which is not demonstrated by
    the data.
...
- Children tended to survive at higher rates than both men and women ,
  with the exception of the third class as the proportion of females is
  relatively the same, whilst the proportion of boys is less than women.
- If you saw something *fishy* in q4 above, use your new plot to explain
  the fishy-ness.
  - It appears as though the higher survival rates for both genders in
    the q4 plot was a result of masking as the children data was
    superimposed upon the adult data, which meant that only the higher
    porportion was illustrated on the graph – in this case, the
    children.
