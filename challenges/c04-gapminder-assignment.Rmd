...
- Oceania tends to have the highest gdp per capita as the entirety of the boxplot is greater than that of the other continents, excluding outliers. Additionally, Europe eppears to have the largest interquartile range, while Oceania has the smallest.

**Difficulties & Approaches**:

- When trying to visualize the data through a simple boxplot, the visual was not informative as the outlier of Kuwait in Asia resulted in the inability to distinguish the boxplots of the continents as the majority of the gdp per capita data remained within the range of 0 to 15000 USD, while the outlier was 108392 USD. This difference in scale resulted in the boxplots appearing as a single line, making it difficult to analyze the data. To counteract this problem, I filtered the data to only display the data for gdpPercap values less than 60000 USD. While this did remove the outlier of Kuwait from the visual, it made it easier to examine the general trends of the data.
- While there are other outliers in Europe and the Americas, these were not hidden as they did not affect the readability of the visual as the lie closer to the majority of the data.
...
How did the dot-com bubble burst of 2000 affect the GDP per capita of continents?

```{r q5-task2}
## gdpPercap 1992 vs 2002
gapminder %>% 
...
- From 2000-2002, the dot-com bubble crashed, resulting in a decrease in 


Did the country with the largest population in each continent change from 1952 to 2007?
