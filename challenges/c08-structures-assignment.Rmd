...
- Is this estimate of the probability of failure trustworthy? Why or why not?
  - No, it is affected by the variability in the strength values.
- Can you confidently conclude that `POF < 0.03`? Why or why not.
  - No, due to the variability in the strengths, the POF is much greater.
...
strength_meanlog <- df_fit[[1, 1]]
strength_sdlog <- df_fit[[2, 1]]
