...
the alphabetical orgering of the manufacturers is not helpful
...
- What are some issues with this graph?
accroding to the visual hierarchy, area is not the most desirable form of visualization as it is difficult to differentiate between the areas
...
- What are some issues with this graph?
comparing against lengths instead of a common axis
...
- What are some issues with this graph?
angles are difficult to differentiate
