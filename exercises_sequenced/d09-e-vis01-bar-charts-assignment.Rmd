...
**Observations**:
- you are seeing the sums of hwy values at each cty 
...
**Observations**:
- you can only see how many cars of each type there are
...
**Observations**:
- you can see not only how many of each car there are, but also how many of each drive type
...
v2 used the fill property to provide more information
...
**Observations**
- manufacturers tend to produce specific types of cars
