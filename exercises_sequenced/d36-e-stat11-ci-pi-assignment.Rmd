...
The CI is in the “middle” of the data.
The PI covers a wider portion of the data, but it goes negative, which is undesirable.
...
A normal distribution is used and the mean and sd are perfectly defined
