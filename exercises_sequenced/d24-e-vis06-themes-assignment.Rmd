...
mpg %>%
  ...
  geom_point() +
  theme(
    line = element_line(size = 3, color = "yellow"),
    rect = element_rect(fill = "blue"),
    axis.text.x = element_text(size = 32, angle = 72),
    axis.text.y = element_text(size = 16, angle = 33),
    axis.title.x = element_text(size = 16, family = "Comic Sans MS"),
