...
EV, FL, YV, F9
- Which carriers differ in the two lists?
HA in sd and 9E in iqr
- Which carrier has the biggest difference between its `sd` and `IQR`? What might this mean?
HA has a very large sd and a small iqr, which could be due to an outlier affecting the mean and sd.
...
df_quad %>%
  summarize(rho = cor(x, y, method = "pearson"), rho_s = cor(x, y, method = "spearman"))
