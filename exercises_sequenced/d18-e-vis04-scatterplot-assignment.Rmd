...
*Purpose*: *Scatterplots* are a key tool for EDA. Scatterplots help us inspect the relationship between two variables. To enhance our scatterplots, we'll learn how to use *layers* in ggplot to add multiple pieces of information to our plots.
...
as displacement increases, the mileage tends to decrease
