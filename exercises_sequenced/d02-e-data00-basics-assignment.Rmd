...
- carat - 0.7979 mean with 4.8100 range
- cut - ideal most common
- color - G color most common
- clarity - SI1 most common
- depth - 61.75 mean, range = 36
- table - 57.46 mean, range = 52
- price - 3933 mean, range = 18497
- x - 5.731 mean, range = 10.740
- y - 5.735 mean, range = 58.9
- z - 3.539 mean, range = 31.8
