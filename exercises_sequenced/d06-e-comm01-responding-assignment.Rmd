...
- Is the bolded response **active** or **passive**? Why?
  active because it engages with the previous comment
- Is the bolded response **constructive** or **destructive**? Why?
  constructive because it responds in a positive manner
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
  this comment is not as demeaning and acknowledges the presenter's mistakes
...
- Is the bolded response **active** or **passive**? Why?
  passive they don't really engages with the comment
- Is the bolded response **constructive** or **destructive**? Why?
  constructive - it acknowledges in a positive manner
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
  it is nice that it acknowledges the mistake in a positive manner, but it does not actually answer the question
...
- Is the bolded response **active** or **passive**? Why?
passive - it is not engaging with the previous statement
- Is the bolded response **constructive** or **destructive**? Why?
mabe destructive as it pulls away from the presenter's presentation
