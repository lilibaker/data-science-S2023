...
carat is continuous, while cut is non-numeric
...
- You are likely to find this visual ineffective; why might that be?
  ...
  different values of cut at each carat result in multiple data points for each carat
...
Yes, the mse is less and the rsquare is greater
...
fit_4c <- 
  ...
  lm(
    data = .,               # Data for fit
    formula = price ~ carat + cut + color + clarity # Formula for fit
  )
...
more accurate as the r-squared value is greater
