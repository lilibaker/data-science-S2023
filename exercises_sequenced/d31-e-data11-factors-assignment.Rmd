...
order of increasing quality of cut
- What---if any---relation does the order of the factor levels have to trends in the data?
levels are a measure of quality, so as they increase, so should the price
...
Europe is now first, everything else shifted to the right
