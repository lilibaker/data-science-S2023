...
no, it is only negative values
- How are the bootstrap results affected?
the mean and sd are much lower than expected
...
at 10, 0.73 is the oberserved coverage probability
- What setting of `n_boot` do you need to set such that the coverage probability approaches the desired `0.95`?
at 1000, a value of 0.88 is obtained, which while still not 0.95, it is much closer
