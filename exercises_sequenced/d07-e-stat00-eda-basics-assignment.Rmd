...
**Observations**:
- no, the hypothesis was not correct. There are more ideal cuts than any other cuts
...
**Observations**:
- you cannot tell from the graph
...
**Observations**:
- ideal is actually the least expensive normally
...
**Observations**:
- the larger carats are more populous in the fair cut,while ideal tends to have lower carats. this suggests that the cut is sacrificed in favor of the carat
