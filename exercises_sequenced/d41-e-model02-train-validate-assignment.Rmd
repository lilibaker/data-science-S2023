...
fit_over <- 
  ...
  lm(
    data = .,
    formula = y_meas ~ poly(x, degree = 17)
  )
...
they mostly match the predictions
...
no because it does not hold outside of these measurements
...
fit_q5 <-
 lm(
   data = diamonds_train,
   formula = price ~ carat + cut + color + clarity # Add more variables!
 )
...
carat has a high influence on price
- Why might the uninformative predictors not be helpful?
they don't have the same predictive power
